...
const settings = {
  ...
  PRIVATE_KEY: process.env.PRIVATE_KEY ? process.env.PRIVATE_KEY : null,
  ...
  AMOUNT_THP_SEND: process.env.AMOUNT_THP_SEND && _isArray(process.env.AMOUNT_THP_SEND) ? JSON.parse(process.env.AMOUNT_THP_SEND) : [0.1, 0.2],
};
